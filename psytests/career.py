...
ANCHORS = [
    L("1️⃣ Umuman qiziq emas", "1️⃣ Совсем не интересно"),
    L("2️⃣ Unchalik qiziq emas", "2️⃣ Не очень интересно"),
    L("3️⃣ Farqi yo‘q", "3️⃣ Всё равно"),
    L("4️⃣ Qiziq", "4️⃣ Интересно"),
    L("5️⃣ Juda qiziq", "5️⃣ Очень интересно"),
]
...
ITEMS = [
    # R
    Item("R", L("Buzilgan texnikani ochib, o‘zim ta’mirlash.",
                "Разобрать сломанную технику и починить её самому.")),
    Item("R", L("Uskuna yoki asbob bilan aniq o‘lchab ishlash.",
                "Работать с инструментом, выполняя точные замеры.")),
    Item("R", L("Ochiq havoda, jismoniy harakat talab qiladigan ish.",
                "Работа на воздухе, требующая физической активности.")),
    Item("R", L("Chizmaga qarab biror narsani yig‘ish yoki qurish.",
                "Собрать или построить что-то по чертежу.")),
    Item("R", L("Transport, texnika yoki jihozlarni boshqarish.",
                "Управлять транспортом, техникой или оборудованием.")),
    # I
    Item("I", L("Muammoning sababini raqamlar orqali aniqlash.",
                "Находить причину проблемы через цифры.")),
    Item("I", L("Ilmiy maqola yoki tadqiqot natijalarini o‘qish.",
                "Читать научные статьи и результаты исследований.")),
    Item("I", L("Murakkab masalani uzoq vaqt yechib o‘tirish.",
                "Долго сидеть над сложной задачей.")),
    Item("I", L("Tajriba o‘tkazib, faraz to‘g‘riligini tekshirish.",
                "Ставить эксперимент и проверять гипотезу.")),
    Item("I", L("Katta ma’lumot to‘plamidan qonuniyat topish.",
                "Искать закономерность в большом массиве данных.")),
    # A
    Item("A", L("Dizayn, rasm yoki video ustida ishlash.",
                "Работать над дизайном, изображением или видео.")),
    Item("A", L("Matn, ssenariy yoki musiqa yozish.",
                "Писать текст, сценарий или музыку.")),
    Item("A", L("Tayyor qolipsiz, o‘z uslubimda ishlash.",
                "Работать без готовых шаблонов, в своём стиле.")),
    Item("A", L("Biror g‘oyani ko‘rinadigan shaklga aylantirish.",
                "Превращать идею в то, что можно увидеть.")),
    Item("A", L("Ko‘rgazma, konsert yoki ijodiy tadbirda qatnashish.",
                "Участвовать в выставке, концерте или творческом событии.")),
    # S
    Item("S", L("Biror narsani boshqa odamga tushuntirib berish.",
                "Объяснять что-то другому человеку.")),
    Item("S", L("Qiyin ahvoldagi odamni qo‘llab-quvvatlash.",
                "Поддерживать человека в трудной ситуации.")),
