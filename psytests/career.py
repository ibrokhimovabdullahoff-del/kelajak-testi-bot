...
ITEMS = [
    ...
    # I
    Item("I", L("Hisob-kitob qilib, muammoning sababini topish.",
                "Находить причину проблемы с помощью расчётов."), kind="interest"),
    Item("I", L("Ilm-fan va kashfiyotlar haqida o‘qish yoki video ko‘rish.",
                "Читать или смотреть видео о науке и открытиях."), kind="interest"),
    Item("I", L("Murakkab masalani uzoq vaqt yechib o‘tirish.",
                "Долго сидеть над сложной задачей."), kind="interest"),
    Item("I", L("Tajriba qilib, nima uchun shunday bo‘lishini bilish (fizika, kimyo, biologiya).",
                "Ставить опыты и выяснять, почему так происходит (физика, химия, биология)."), kind="interest"),
    Item("I", L("Kompyuterda dastur, o‘yin yoki sayt yaratish.",
                "Создавать программы, игры или сайты на компьютере."), kind="interest"),
    # A
    ...
    Item("A", L("Hech kimga o‘xshamagan, o‘z uslubingizda biror narsa yaratish.",
                "Создавать что-то своё, ни на кого не похожее."), kind="interest"),
    Item("A", L("Kiyim, xona yoki buyumning chiroyli ko‘rinishini o‘ylab topish.",
                "Придумывать, как красиво оформить одежду, комнату или вещь."), kind="interest"),
    ...
    Item("E", L("Odamlarni o‘z fikringizga ishontirish va kelishuvga erishish.",
                "Убеждать людей и договариваться."), kind="interest"),
    ...
    Item("C", L("Ishni yoki tadbirni puxta rejalashtirib, hammasini tartibga solish.",
                "Тщательно планировать дело или мероприятие и всё организовывать."), kind="interest"),
]
